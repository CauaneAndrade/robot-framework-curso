...
Rodando uma keyword dada uma condição = false
    Run Keyword Unless  '${FRUTAS[1]}' == 'maça'    Log To Console  O item número 1 não é uma ${FRUTAS[1]}!!

Armazenando um valor em uma variável dada uma condição
    ${VAR}     Set Variable If   '${FRUTAS[1]}' == 'banana'     banana    Log    Minha variável VAR é uma ${VAR}!!
    ${VAR}     Set Variable If   '${FRUTAS[1]}' != 'uva'     banana    Log    Minha variável VAR é uma ${VAR}!!
